...
/* Upraveny pre nahranie aplikacneho firmwaru za bootloader */
...
MEMORY
{
    FLASH (rxai!w) : ORIGIN = 0x80004000, LENGTH = 496K  /* Tu treba upravit 1 hodnotu */
...
SECTIONS
{
  ...
  PROVIDE (__executable_start = 0x80004000); . = 0x80004000;  /* Tu treba upravit 2 hodnoty */
